...
public class Cuadrilatero {
	...
	/*
	 * Se comprobaban los lados opuestos, los cuales pueden ser iguales sin necesidad de que
	 * la figura sea un cuadrado, podemos evitar esto comparando los lados contiguos.
	 * */
